...
>
  <h2>Σχετικά με εμάς</h2>
        ...
        >
          ...
          στην Καστοριά. Συνδυάζουμε την ελληνική παράδοση με
          σύγχρονες γεύσεις και ποιοτικές πρώτες ύλες.
        </p>
      </section>
...
/>
  ...
  >
    <input name="name" type="text" placeholder="Ονοματεπώνυμο" style={inputStyle} required />
    <input name="phone" type="tel" placeholder="Τηλέφωνο" style={inputStyle} required />
...
{showPopup && (
  ...
  Η κράτησή σας καταχωρήθηκε επιτυχώς και η ομάδα μας
  θα επικοινωνήσει μαζί σας για επιβεβαίωση.
</p>
